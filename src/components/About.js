        ...
        <div className="about">
            ...
            <div className="about-img-div shadow">
                <div className="about-img">
                    <img className="w-11/12 md:w-10/12 mx-auto py-8 shadow-2 " src={businessWomen} alt="business-women" />
                </div>
            </div>
            
            
            <div className="our-story-div mt-6 lg:pt-8">
                <div className="our-story xl:flex xl:mx-auto xl:w-11/12">
                    <h1 className="xl:hidden order-last text-2xl text-center pt-6 lg:text-4xl">OUR STORY</h1>
                    <img className="mt-8 w-11/12 md:10/12 mx-auto xl:h-2/3 xl:w-1/2" src={groupLadies} alt="group of girls" />
                    <div className="story-writeup mt-6 px-6 md:text-lg lg:text-2xl xl:w-1/2 xl:pl-10 xl:text-3xl">
                        <h1 className="hidden xl:block text-4xl">OUR STORY</h1>
                        <p className="mt-3">
                ...
                <div className="get-in-touch flex mt-16 w-11/12 xl:w-full mx-auto xl:mx-0 justify-around items-center xl:items-start lg:mt-20">
                    <div className="get-in-touch-list mr-4 md:text-xl lg:text-2xl">
                        <h2 className="text-[17px] md:text-2xl lg:text-3xl">GET IN TOUCH</h2>
                ...
                <div className="sign-up-div mt-10 lg:mt-16 pb-10 lg:pb-16 text-center">
                    <h3 className="text-base md:text-2xl lg:text-3xl">READY TO GET STARTED?</h3>
                    <button className="sign-up py-1 px-3 lg:py-2 lg:px-4 rounded mt-1 lg:text-xl"><a href="/sign-up">SIGN UP</a></button>
                </div>
            </div>
            <AboutTrestle />
            <Footer />
